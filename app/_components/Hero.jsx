...
function Hero() {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center min-h-[60vh] px-4 space-y-6">
            <h2 className="text-primary text-5xl font-bold">{Lookup.HeroHeading}</h2>
            <h2 className="text-blue-600 text-3xl font-semibold">{Lookup.HeroSubheading}</h2>
            ...
            <div className="flex gap-4 w-full max-w-2xl">
                ...
                <Button className="h-[48px] px-6">Get Start</Button>
                </Link>
